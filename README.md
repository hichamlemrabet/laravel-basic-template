...
-> write: git clone https://github.com/hichamlemrabet/laravel_basic_template.git folderClone <br> (you can choose name of folder)

## 2) Setup Composer Dependencies 
-> write: cd folderClone <br>
-> write: composer install <br>
-> write: npm install
...
## 5) Setup Database
-> go to the .env file and setup a database (DB_HOST, DB_PORT, DB_DATABASE, DB_USERNAME, DB_PASSWORD) <br>
